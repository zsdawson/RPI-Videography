...
# delete all photos in the Pictures folder
...
system('ffmpeg -r {} -f image2 -s 1024x768 -nostats -loglevel 0 -pattern_type '
       'glob -i "/home/pi/Pictures/*.jpg" -vcodec libx264 -crf 25  -pix_fmt yuv4'
       '20p /home/pi/Videos/{}.mp4'.format(fps, datetimeformat))
# system('rm /home/pi/Pictures/*.jpg')
